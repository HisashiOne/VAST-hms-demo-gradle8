...
import static com.dtse.huawei.demo.hms.training.Constants.BLACK_COLOR;
import static com.dtse.huawei.demo.hms.training.Constants.CORNER_RADIUS;
import static com.dtse.huawei.demo.hms.training.Constants.DESC_TEXT_SIZE;
import static com.dtse.huawei.demo.hms.training.Constants.DETAIL_TEXT_SIZE;
import static com.dtse.huawei.demo.hms.training.Constants.GRAY_COLOR;
import static com.dtse.huawei.demo.hms.training.Constants.LINEAR_SLOT_ID;
import static com.dtse.huawei.demo.hms.training.Constants.TITLE_TEXT_SIZE;
import static com.dtse.huawei.demo.hms.training.Constants.TOTAL_DURATION;
import static com.dtse.huawei.demo.hms.training.Constants.WHITE_COLOR;
...
import com.dtse.huawei.demo.hms.training.MainActivity;
import com.dtse.huawei.demo.hms.training.R;
import com.dtse.huawei.demo.hms.training.bean.AdConfig;
import com.dtse.huawei.demo.hms.training.custome.CustomVideoController;
    ...
    private void startLinearAd(LinearAdSlot linearAdSlot) {
        VastAdPlayer.getInstance().startLinearAd(linearAdSlot, new AdsRequestListener() {
            ...
            public void onSuccess(View view, int responseCode) {
                ...
                Log.e("ZGA", "Success Play Linear AD " + responseCode);
            }

            @Override
            public void onFailed(View view, int responseCode) {

                Log.e("ZGA", "Error Play Linear AD " + responseCode);
            }
