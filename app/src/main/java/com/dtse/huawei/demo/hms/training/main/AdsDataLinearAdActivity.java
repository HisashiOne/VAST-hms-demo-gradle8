...
import static com.dtse.huawei.demo.hms.training.Constants.LINEAR_HEIGHT_SIZE;
import static com.dtse.huawei.demo.hms.training.Constants.LINEAR_SLOT_ID;
import static com.dtse.huawei.demo.hms.training.Constants.LINEAR_WIDTH_SIZE;
    ...
    private void playLinearAd() {
        VastAdPlayer.getInstance().playLinearAds(mLinearAdSlot, mAdsData, new AdsRequestListener() {
            ...
            public void onSuccess(View view, int responseCode) {
                ...
                Log.e("ZGA", "Sucess Play Linear AD " + responseCode);
            }
